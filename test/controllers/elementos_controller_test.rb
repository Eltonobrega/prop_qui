...
class ElementosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create elemento" do
    assert_difference('Elemento.count') do
      post elementos_url, params: { elemento: { componente: @elemento.componente, estado: @elemento.estado, massa: @elemento.massa } }
    end
  ...
  test "should update elemento" do
    patch elemento_url(@elemento), params: { elemento: { componente: @elemento.componente, estado: @elemento.estado, massa: @elemento.massa } }
